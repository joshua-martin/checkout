        ...
        <div className="container mx-auto my-8 flex max-w-5xl flex-row items-start space-x-6">
            <div className="prose-sm w-2/3 flex-shrink-0 rounded-lg p-6 shadow-lg">
                ...
                <p className="mb-1">
                    Some guy
                    <br />
                    Some address one, town, postcode
                    <br />
                    +0000000000
                </p>
                <p className="mt-0">
                    <strong className="text-blue-500">Change Address</strong>
                </p>
                <hr className="my-4" />
                ...
                <div className="inline-block w-auto pb-4">
                    <span className="flex w-auto items-center rounded-lg p-2 font-bold uppercase text-blue-500 shadow-md">
                        <span className="mr-2">TENOFF</span>

                        <span title="Do Not Use Code" className="text-gray-600">
